...
def run_demo():
    ...
    if not save_mode:
        print("DEMO: Supervised Single-Scale PatchTST (Baseline)")
    ...
    model_save_dir = os.path.join(base_save_dir, 'supervised_single')
    os.makedirs(model_save_dir, exist_ok=True)
    
    # Setup config (using d_model=128 for all horizons)
    class Config:
        pass
    ...
    args_config.patch_len = 16
    args_config.stride = 8
    ...
    # Checkpoint paths for each horizon
    checkpoint_paths = {
        96: 'checkpoints/ETTh1_336_96_baseline_PatchTST_ETTh1_ftM_sl336_ll48_pl96_dm128_nh8_el3_dl1_df256_fc1_ebtimeF_dtTrue_test_0/checkpoint.pth',
        192: 'checkpoints/ETTh1_336_192_baseline_PatchTST_ETTh1_ftM_sl336_ll48_pl192_dm128_nh8_el3_dl1_df256_fc1_ebtimeF_dtTrue_test_0/checkpoint.pth',
        336: 'checkpoints/ETTh1_336_336_baseline_PatchTST_ETTh1_ftM_sl336_ll48_pl336_dm128_nh8_el3_dl1_df256_fc1_ebtimeF_dtTrue_test_0/checkpoint.pth',
        720: 'checkpoints/ETTh1_336_720_baseline_PatchTST_ETTh1_ftM_sl336_ll48_pl720_dm128_nh8_el3_dl1_df256_fc1_ebtimeF_dtTrue_test_0/checkpoint.pth',
    }
    ...
    for horizon in horizons:
        ...
        # Save ground truth for T=96 only
        if horizon == 96:
            gt_np = demo_target[:, -96:, f_dim:].numpy()
            np.save(os.path.join(base_save_dir, 'ground_truth.npy'), gt_np)
        
        # Load model
        model = PatchTST(args_config).cuda()
    ...
    # Print summary table
    if not save_mode:
        print("SUMMARY - Supervised Single-Scale Baseline")
