...
import os
import torch
from exp.exp_main_dual import Exp_Main_Dual
import random
import numpy as np
import time
import json
...
def save_results_to_csv(all_results, results_file='dual_scale_results.csv'):
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Dual-Scale PatchTST for Time Series Forecasting')
    ...
    parser.add_argument('--model', type=str, required=True, default='DualScalePatchTST', help='model name')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            result_entry = {
                ...
                'mae': mae,
                'rse': rse,
                'notes': 'Dual-Scale PatchTST: fine P=8, coarse P=32'
            }
